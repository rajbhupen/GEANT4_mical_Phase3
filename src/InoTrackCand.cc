...
//----------------------------------------------------------------------
void InoTrackCand::SetXdevLay1(double val) {
  XdevLay1 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay1() const {
  return XdevLay1;
}


void InoTrackCand::SetYdevLay1(double val) {
  YdevLay1 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay1() const {
  return YdevLay1;
}
...
//----------------------------------------------------------------------
void InoTrackCand::SetXdevLay2(double val) {
  XdevLay2 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay2() const {
  return XdevLay2;
}


void InoTrackCand::SetYdevLay2(double val) {
  YdevLay2 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay2() const {
  return YdevLay2;
}
...
void InoTrackCand::SetXdevLay3(double val) {
  XdevLay3 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay3() const {
  return XdevLay3;
}


void InoTrackCand::SetYdevLay3(double val) {
  YdevLay3 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay3() const {
  return YdevLay3;
}


  
void InoTrackCand::SetXdevLay4(double val) {
  XdevLay4 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay4() const {
  return XdevLay4;
}


void InoTrackCand::SetYdevLay4(double val) {
  YdevLay4 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay4() const {
  return YdevLay4;
}


  
void InoTrackCand::SetXdevLay5(double val) {
  XdevLay5 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay5() const {
  return XdevLay5;
}


void InoTrackCand::SetYdevLay5(double val) {
  YdevLay5 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay5() const {
  return YdevLay5;
}
...
void InoTrackCand::SetXdevLay6(double val) {
  XdevLay6 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay6() const {
  return XdevLay6;
}


void InoTrackCand::SetYdevLay6(double val) {
  YdevLay6 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay6() const {
  return YdevLay6;
}



void InoTrackCand::SetXdevLay7(double val) {
  XdevLay7 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay7() const {
  return XdevLay7;
}


void InoTrackCand::SetYdevLay7(double val) {
  YdevLay7 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay7() const {
  return YdevLay7;
}
...
void InoTrackCand::SetXdevLay8(double val) {
  XdevLay8 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay8() const {
  return XdevLay8;
}


void InoTrackCand::SetYdevLay8(double val) {
  YdevLay8 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay8() const {
  return YdevLay8;
}
...
void InoTrackCand::SetXdevLay9(double val) {
  XdevLay9 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay9() const {
  return XdevLay9;
}


void InoTrackCand::SetYdevLay9(double val) {
  YdevLay9 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay9() const {
  return YdevLay9;
}
...
void InoTrackCand::SetXdevLay10(double val) {
  XdevLay10 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay10() const {
  return XdevLay10;
}


void InoTrackCand::SetYdevLay10(double val) {
  YdevLay10 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay10() const {
  return YdevLay10;
}



void InoTrackCand::SetXdevLay11(double val) {
  XdevLay11 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay11() const {
  return XdevLay11;
}


void InoTrackCand::SetYdevLay11(double val) {
  YdevLay11 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay11() const {
  return YdevLay11;
}



void InoTrackCand::SetXdevLay12(double val) {
  XdevLay12 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetXdevLay12() const {
  return XdevLay12;
}


void InoTrackCand::SetYdevLay12(double val) {
  YdevLay12 = val;
}

//----------------------------------------------------------------------
double InoTrackCand::GetYdevLay12() const {
  return YdevLay12;
}
