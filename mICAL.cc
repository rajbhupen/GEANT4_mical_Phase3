...
int main(int argc,char** argv) {
  ...
  //  Write the GDML files
  // parser.Write("detector_world20rpc.gdml", G4TransportationManager::GetTransportationManager()->GetNavigatorForTracking()->GetWorldVolume());
